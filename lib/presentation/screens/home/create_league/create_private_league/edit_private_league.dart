...
class EditPrivateLeagueScreen extends StatefulWidget {
  const EditPrivateLeagueScreen({super.key});

  @override
  State<EditPrivateLeagueScreen> createState() =>
      _EditPrivateLeagueScreenState();
}

class _EditPrivateLeagueScreenState extends State<EditPrivateLeagueScreen> {
  ...
  void _saveChanges() {
    if (_isFormValid) {
      ...
      // Example: Save to database, API call, etc.
