...
class EditPublicLeagueScreen extends StatefulWidget {
  const EditPublicLeagueScreen({super.key});

  @override
  State<EditPublicLeagueScreen> createState() =>
      _EditPublicLeagueScreenState();
}

class _EditPublicLeagueScreenState extends State<EditPublicLeagueScreen> {
