...
class CreatePublicLeagueWaitingRoomScreen extends StatefulWidget {
  const CreatePublicLeagueWaitingRoomScreen({super.key});

  @override
  State<CreatePublicLeagueWaitingRoomScreen> createState() =>
      _CreatePublicLeagueWaitingRoomScreenState();
}

class _CreatePublicLeagueWaitingRoomScreenState
    extends State<CreatePublicLeagueWaitingRoomScreen> {
                ...
                children: [
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () => context.go(RoutePath.editPublicLeagueScreen.addBasePath),
                  ...
                  SizedBox(
                    ...
                    height: 56,
                    child: ElevatedButton(
                      onPressed: () => context.go(RoutePath.selectPlayerScreen .addBasePath),
                      style: ElevatedButton.styleFrom(
